...
<div class="sqrpara sqschoiseblock novalpayments novalnetmultibanco">
	<div class="sqrform">
		<p id="novalnetmultibanco_test" class="sqrformerr">{_nnmultibanco_testmode}</p>
	</div>
	<div>{_nnmultibancocustomeinfo}</div>	
	<div><img src="{_nnmultibanco_paymentlogo}" alt="Novalnet AG"></div>
</div>
...
<div class="sqrpara sqschoiseblock novalpayments novalnetpostfinance">
	<div class="sqrform">
		<p id="novalnetpostfinance_test" class="sqrformerr">{_nnpostfinance_testmode}</p>
	</div>
	<div>{_nnpostfinancecustomeinfo}</div>
	<div><img src="{_nnpostfinance_paymentlogo}" alt="Novalnet AG"></div>	
</div>

<div class="sqrpara sqschoiseblock novalpayments novalnetfinancecard">
	<div class="sqrform">
		<p id="novalnetfinancecard_test" class="sqrformerr">{_nnpostfinancecard_testmode}</p>
	</div>
	<div>{_nnpostfinancecardcustomeinfo}</div>
	<div><img src="{_nnpostfinancecard_paymentlogo}" alt="Novalnet AG"></div>	
</div>

<div class="sqrpara sqschoiseblock novalpayments novalnetbancontact">
	<div class="sqrform">
		<p id="novalnetbancontact_test" class="sqrformerr">{_nnbancontact_testmode}</p>
	</div>
	<div>{_nnbancontactcustomeinfo}</div>
	<div><img src="{_nnbancontact_paymentlogo}" alt="Novalnet AG"></div>	
</div>
