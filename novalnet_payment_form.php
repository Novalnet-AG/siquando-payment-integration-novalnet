// Novalnet code STARTS
					...
					if($pm->parameter[0] == 'novalnetcc') {
						...
						$lang = defined('CC_SHOP_NNLANG') ? CC_SHOP_NNLANG : substr($order->client->country, 0, 2);
						// Iframe path
						$iframe_path = 'https://secure.novalnet.de/cc?api='. $signature . '&ln=' .strtolower($lang);
					...
					elseif($pm->parameter[0] == 'novalnetpostfinance') { // For Postfinance
						$postfinance = array(
							'_nnpostfinance_paymentlogo' => ($global_config[6] == '1') ? 'images/novalnet/postfinance.png' : '',
							'_nnpostfinancecustomeinfo'  => $pm->parameter[2],
							'_nnpostfinance_testmode'     => ($pm->parameter[1] == '1') ? CC_SITE_NNTESTORDER_MESSAGE : '',
						);
					}
					elseif($pm->parameter[0] == 'novalnetfinancecard') { // For Postfinance card
						$postfinancecard = array(
							'_nnpostfinancecard_paymentlogo' => ($global_config[6] == '1') ? 'images/novalnet/postfinancecard.png' : '',
							'_nnpostfinancecardcustomeinfo'  => $pm->parameter[2],
							'_nnpostfinancecard_testmode'     => ($pm->parameter[1] == '1') ? CC_SITE_NNTESTORDER_MESSAGE : '',
						);
					}
					elseif($pm->parameter[0] == 'novalnetbancontact') { // For Bancontact
						$bancontact = array(
							'_nnbancontact_paymentlogo' => ($global_config[6] == '1') ? 'images/novalnet/bancontact.png' : '',
							'_nnbancontactcustomeinfo'  => $pm->parameter[2],
							'_nnbancontact_testmode'     => ($pm->parameter[1] == '1') ? CC_SITE_NNTESTORDER_MESSAGE : '',
						);
					}
					...
					elseif($pm->parameter[0] == 'novalnetmultibanco') { // For Multibanco
						$multibanco = array(
							'_nnmultibanco_paymentlogo' => ($global_config[6] == '1') ? 'images/novalnet/multibanco.png' : '',
							'_nnmultibancocustomeinfo'  => $pm->parameter[2],
							'_nnmultibanco_testmode'     => ($pm->parameter[1] == '1') ? CC_SITE_NNTESTORDER_MESSAGE : '',
						);
					}
